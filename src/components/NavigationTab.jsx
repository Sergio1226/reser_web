export function NavigationTab({ state, setState, options }) {
  return (
    <div className="w-fit p-8 bg-white rounded-xl shadow-md flex flex-row items-center space-x-6 border border-black/20">
      {options.map((opt, index) => (
        ...
        >
          ...
          {/* barra inferior que cambia con click o hover */}
          <div
            className={`
              w-full h-2 mt-2 transition-colors rounded 
