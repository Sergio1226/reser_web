        ...
        <main className="p-4 md:p-6 flex flex-col lg:flex-row flex-1 space-y-6 lg:space-y-0 lg:space-x-6">
          <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-lg flex-1">
            ...
            <div className="flex mb-6 items-center justify-center space-x-4">
              ...
              />
              <h2 className="text-center px-5 py-2 bg-gradient-to-r from-blue-500 to-indigo-500 text-white rounded-lg text-sm font-semibold shadow-md hover:shadow-lg flex items-center gap-2 hover:-translate-y-0.5 transition-transform">
                <CalendarSingle
                  date={date}
                  setDate={setDate}
                  label="text-white"
