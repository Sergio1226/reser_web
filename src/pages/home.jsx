...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-primary bg-gradient-to-b from-white to-gray-50 overflow-x-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row items-stretch justify-center gap-6 px-4 sm:px-6 py-8 sm:py-10 w-full overflow-x-hidden">
        <div className="flex-1 bg-secondary rounded-2xl border border-black/10 shadow-lg p-6 sm:p-8 flex flex-col items-center text-center w-full max-w-full">
        ...
        <div className="flex-1 bg-secondary rounded-2xl border border-black/10 shadow-lg flex items-center justify-center p-4 sm:p-6 w-full max-w-full">
          <iframe
