...
export function BookingTable() {
  ...
  const finishedBookings = bookings.filter(b => b.status === "Finalizada").length;
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-300 rounded-xl p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-slate-600 font-medium mb-1">Todas</p>
              <p className="text-3xl font-bold text-slate-700">{totalBookings}</p>
            </div>
            <div className="text-4xl">
              <Icon name="list" style="size-[40px]" />
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-blue-600 font-medium mb-1">Finalizadas</p>
              <p className="text-3xl font-bold text-blue-700">{finishedBookings}</p>
            </div>
            <div className="text-4xl">
              ✓✓
            </div>
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 border border-red-200 rounded-xl p-6 shadow-md">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-red-600 font-medium mb-1">Canceladas</p>
